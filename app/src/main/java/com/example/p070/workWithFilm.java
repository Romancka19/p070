...
public class workWithFilm extends AppCompatActivity {
    TextView tvInfo;
    EditText tvName;
    Button tvButton;
    Button tvButtonU;
    Button tvButtonD;
    workWithFilm.MyTask mt;

    workWithFilm.MyTaskU mtu;
    workWithFilm.MyTaskD mtd;
    ListView lvMain;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_work_with_film);
    ...
    class MyTask extends AsyncTask<String, Void, ArrayList<String[]>> {
        ...
        protected ArrayList<String[]> doInBackground(String... params) {
            ...
            String total = "";
            try {
                URL githubEndpoint = new URL("http://10.0.2.2:8080/kino/films2?name=" + params[0]);
                myConnection =
        ...
        protected void onPostExecute(ArrayList<String[]> result) {
            ...
            workWithFilm.ClAdapter clAdapter = new workWithFilm.ClAdapter(tvInfo.getContext(), result);
            lvMain = (ListView) findViewById(R.id.lvMain);
...
//            int n=lvMain.getChildCount();
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (ch.isChecked()) {
                ...
                try {
                    ...
                    JA.getJSONObject(m).put("id", st[1]);
                } catch (JSONException e) {
                    e.printStackTrace();
                }
                m++;
    ...
    class MyTaskU extends AsyncTask<JSONArray, Void, String> {
        ...
        protected String doInBackground(JSONArray... jsonArrays) {
            ...
            JSONObject obj = null;
            try {
                URL githubEndpoint = new URL("http://10.0.2.2:8080/kino/update_film");
                myConnection =
                        (HttpURLConnection) githubEndpoint.openConnection();
            } catch (MalformedURLException e) {
                e.printStackTrace();
...
//                tvInfo.setText(str);
    ...
    class MyTaskD extends AsyncTask<JSONArray, Void, String> {
        ...
        protected String doInBackground(JSONArray... jsonArrays) {
            ...
            JSONObject obj = null;
            try {
                URL githubEndpoint = new URL("http://10.0.2.2:8080/kino/delete_film");
                myConnection =
                        (HttpURLConnection) githubEndpoint.openConnection();
            } catch (MalformedURLException e) {
                e.printStackTrace();
